...
360Lib-13.4 software has dependency with VTM software. It can work with VTM-19.0. 
1. VTM-19.0-360Lib-13.4 software preparation
  1.1 check out VTM-19.0 ( https://vcgit.hhi.fraunhofer.de/jvet/VVCSoftware_VTM/tags/VTM-19.0 );
      check out 360Lib-13.4( https://jvet.hhi.fraunhofer.de/svn/svn_360Lib/tags/360Lib-13.4 ); 
  1.2 copy following directories (./360Lib-13.4) to ./VTM-19.0
      1.2.1 copy source files:
          copy ./360Lib-13.4/source/Lib/Lib360 to ./VTM-19.0/source/Lib/
          copy ./360Lib-13.4/source/Lib/AppEncHelper360 to ./VTM-19.0/source/Lib/
          copy ./360Lib-13.4/source/App/utils/App360Convert to ./VTM-19.0/source/App/utils/
      1.2.2 copy configure files:
          copy ./360Lib-13.4/cfg-360Lib to ./VTM-19.0/
      
  1.3 build VTM-19.0-360Lib-13.4 software: 
      use CMake to generate makefile for Linux platform (check ./360Lib-13.4/360Lib-CMakeReadme.txt); use make command to build executables; 
      use CMake to generate solution files for Windows platform (check ./360Lib-13.4/360Lib-CMakeReadme.txt); use Visual Studio to build executables;
